...
export const CONSUMABLES: SrdItem[] = [
  ...
  { roll: 48, name: "Dragonbloom Tea", description: "You can drink this tea to unleash a fiery breath attack. Make an Instinct Roll against all adversaries in front of you within Close range. Targets you succeed against take 2d20 physical damage using your Proficiency." },
  { roll: 49, name: "Bridge Seed", description: "Thick vines grow from your location to a point of your choice within Far range, allowing you to climb up or across them. The vines dissipate on your next rest." },
  ...
  { roll: 56, name: "Sweet Moss", description: "You can consume this moss during a rest to clear 1d10 HP or 1d10 Stress." },
